        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contests_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTalents", x => new { x.UserId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_UserTalents_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentGroupPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentGroupPosts_CommentGroupPosts_ParentCommentId",
                        column: x => x.ParentCommentId,
                        principalTable: "CommentGroupPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CommentGroupPosts_GroupPosts_GroupPostId",
                        column: x => x.GroupPostId,
                        principalTable: "GroupPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentGroupPosts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentGroupPosts_CreatedAt",
                table: "CommentGroupPosts",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_CommentGroupPosts_GroupPostId",
                table: "CommentGroupPosts",
                column: "GroupPostId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentGroupPosts_ParentCommentId",
                table: "CommentGroupPosts",
                column: "ParentCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentGroupPosts_UserId",
                table: "CommentGroupPosts",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupPosts_LastActivityDate",
                table: "GroupPosts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTalents_CategoryId",
                table: "UserTalents",
                column: "CategoryId");
